...
//< keyword-map
  ...
  private final List<com.craftinginterpreters.lox.Token> tokens = new ArrayList<>();
//> scan-state
  private int start = 0;
...
//> scan-tokens
  List<com.craftinginterpreters.lox.Token> scanTokens() {
    ...
    tokens.add(new com.craftinginterpreters.lox.Token(EOF, "", null, line));
    return tokens;
  }
//< scan-tokens
//> scan-token
...
//> advance-and-add-token
  ...
  private void addToken(TokenType type, Object literal) {
    String text = source.substring(start, current);
    tokens.add(new com.craftinginterpreters.lox.Token(type, text, literal, line));
  }
//< advance-and-add-token
}
